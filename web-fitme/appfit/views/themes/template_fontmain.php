...
<head>
	...
	<link rel="icon" href="<?=base_url('assets/canvas/images/logo2.png'); ?>" type="image/x-icon"> 
    <link rel="shortcut icon" href="<?=base_url('assets/canvas/images/logo2.png'); ?>" type="image/x-icon">

	<link href="<?=base_url('assets/canvas/font-awesome/css/font-awesome.css');?>" rel="stylesheet">
	...
	<link rel="stylesheet" href="<?=base_url('assets/canvas/css/custom.css?v=2'); ?>" type="text/css" />

	<!-- Document Title
	============================================= -->
	<title>Suvarnabhumi</title>
...
<body class="stretched">
	...
	<script type="text/javascript" src="https://maps.google.com/maps/api/js?key=AIzaSyB78ypUYFHLovm74hALfiaTGFN7GHGUVxk"></script>
	<script type="text/javascript" src="<?=base_url('assets/canvas/js/lib/jquery.gmap.js'); ?>"></script>

	<!-- Footer Scripts
	============================================= -->
	<script type="text/javascript" src="<?=base_url('assets/canvas/js/lib/functions.js'); ?>"></script>
	<script type="text/javascript" src="<?=base_url('assets/canvas/js/lib/dropdows.js'); ?>"></script>
</body>
</html>
