...
public abstract class AbstractDataProviderSwipeable {
    ...
    public static abstract class Data {
        ...
        public abstract String getTextYear();

        public abstract String getTextName();

        public abstract String getTextEmail();


        public abstract String getPicture_link();
