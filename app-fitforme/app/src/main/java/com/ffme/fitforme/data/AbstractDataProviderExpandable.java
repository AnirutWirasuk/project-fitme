...
public abstract class AbstractDataProviderExpandable {
    public static abstract class BaseData {


        public abstract String getName();

        public abstract String getGroupEmail();

        public abstract String getGroupYear();

        public abstract Integer getGroupAvatar();

        public abstract String getAvatar_image_url();

        public abstract String getGroupAvatar_link();
    ...
    public static abstract class ChildData extends BaseData {
        ...
        public abstract String getChildTelephone();
